				...
				<div class="wt-messagescontent">
					...
					<div class="wt-messagesfile__title">
						<# if(element.chat_filename) { #>
							<a href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{element.chat_hashname}}" download>{{element.chat_filename}}</a>
						<# } else { #>
							<a href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{element.chat_hashname}}" download>{{element.chat_filename}}</a>
						<# } #>
					...
					<# if(element.chat_filename) { #>
						<a class="wt-messagesfile__uploader" href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{element.chat_hashname}}" download></a>
					<# } else { #>
						<a class="wt-messagesfile__uploader" href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{element.chat_hashname}}" download></a>
					<# } #>
				</div> 
	...
	<div class="wt-messagescontent">
		<figure class="wt-meassagesfig">
			<# if(data.chat_filename) { #>
				<img src="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{data.chat_hashname}}">
			<# } else { #>
				<img src="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{data.chat_hashname}}">
			<# } #>
			<# if(data.chat_filename) { #>
				<a target="_blank" href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{data.chat_hashname}}"><i class="ti-share"></i>{{data.name}}</a>
			<# } else { #>
				<a target="_blank" href="<?php echo esc_url($upload_dir_path."/chat_attachments"); ?>/{{data.chat_hashname}}"><i class="ti-share"></i>{{data.name}}</a>
			<# } #>
